...
export class CamaraComponent implements OnInit {
  ...
  fichadaShow: boolean = false;
  menuMostarOcultar: string = "Ver Fichadas";
  ...
  mostarOcultarFichada() {
    this.fichadaShow = !this.fichadaShow; 
    this.menuMostarOcultar === "Ver Fichadas"? this.menuMostarOcultar = "Ocultar Fichadas" : this.menuMostarOcultar = "Ver Fichadas";    
  }
  ...
  async scanSuccessHandler(event:string){    
    ...
    try{      
      ...
      fichadaAnterior.fichadaFH.getMinutes() + 2 > fichadaActual.fichadaFH.getMinutes() ){                  
        ...
        this.mensaje = fichadaAnterior.persona_personaNombre + " podes volver Fichadas a fichar a las " +
